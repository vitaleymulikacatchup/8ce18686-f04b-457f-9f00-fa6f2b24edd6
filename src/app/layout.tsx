...
export const metadata: Metadata = {
  title: "Inoday Flowers | Premium Floral Design Studio",  description: "Handcrafted floral arrangements for weddings, events, and subscriptions. Premium floristry studio creating beautiful flower designs.",  keywords: ["flowers", "florist", "floral design", "wedding flowers", "arrangements", "bouquet", "events"],
  metadataBase: new URL("https://inodayflowers.com"),
  alternates: {
    canonical: "https://inodayflowers.com"
  },
  openGraph: {
    title: "Inoday Flowers | Premium Floral Design",    description: "Handcrafted floral arrangements and custom designs for your special moments",    siteName: "Inoday",    type: "website",    images: [{
      url: "http://img.b2bpic.net/free-photo/decoration-artificial-flower_1232-2043.jpg",      alt: "Inoday Premium Flowers"
    }]
  },
  twitter: {
    card: "summary_large_image",    title: "Inoday Flowers | Premium Floral Design",    description: "Handcrafted floral arrangements and custom designs",    images: ["http://img.b2bpic.net/free-photo/decoration-artificial-flower_1232-2043.jpg"]
  },
  robots: {
    index: true,
    follow: true
